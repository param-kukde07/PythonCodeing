...
# Step-----2------Import Libraries needed to make this application
from tkinter import *
...
app.resizable(0,0)
app.title("Spelling Checker and Corrector App")


# Step-----4------Create the text and words entry widgets 
heading_text=Label(app,text="Welcome to Spell Checcker and Corrector App",font='Arial 16 bold',fg='White',bg='black')
